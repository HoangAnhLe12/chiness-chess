...
;(function () {
  ...
  function expandConfig (config) {
    ...
    if (!config.hasOwnProperty('pieceTheme') ||
      ...
      config.pieceTheme = 'https://lengyanyu258.github.io/xiangqiboardjs/img/xiangqipieces/wikimedia/{piece}.svg'
    }

    // default board theme is wikimedia
    if (!config.hasOwnProperty('boardTheme') || !isString(config.boardTheme)) {
      config.boardTheme = 'https://lengyanyu258.github.io/xiangqiboardjs/img/xiangqiboards/wikimedia/xiangqiboard.svg'
    }
